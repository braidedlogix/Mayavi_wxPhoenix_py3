...
class FloatArray(DataArray):
    """
    FloatArray - dynamic, self-adjusting array of float
    
    Superclass: DataArray
    
    FloatArray is an array of values of type float.  It provides
    methods for insertion and retrieval of values and will automatically
    resize itself to hold new data.
    
    """
    def __init__(self, obj=None, update=True, **traits):
        tvtk_base.TVTKBase.__init__(self, vtk.vtkFloatArray, obj, update, **traits)
    ...
    def get_typed_tuple(self, *args):
        ...
        C++: void GetTypedTuple(IdType i, float *tuple)"""
    ...
    def set_typed_tuple(self, *args):
        ...
        C++: void SetTypedTuple(IdType i, const float *tuple)"""
    ...
    def set_value(self, *args):
        ...
        C++: void SetValue(IdType id, float value)"""
    ...
    def insert_next_typed_tuple(self, *args):
        ...
        C++: IdType InsertNextTypedTuple(const float *tuple)"""
    ...
    def insert_next_value(self, *args):
        ...
        C++: IdType InsertNextValue(float f)"""
    ...
    def insert_typed_tuple(self, *args):
        ...
        C++: void InsertTypedTuple(IdType i, const float *tuple)"""
    ...
    def insert_value(self, *args):
        ...
        C++: void InsertValue(IdType id, float f)"""
    ...
    def write_pointer(self, *args):
        ...
        C++: float *WritePointer(IdType id, IdType number)"""
    ...
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(FloatArray, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            View((Item("handler._full_traits_list",show_label=False)),
            title='Edit FloatArray properties', scrollable=True, resizable=True,
