...
class HyperOctree(DataSet):
    ...
    * Binary tree:
    ...
    ('dimension', 'GetDimension'), ('dual_grid_flag', 'GetDualGridFlag'),
    ('origin', 'GetOrigin'), ('size', 'GetSize'), ('reference_count',
    'GetReferenceCount'))
    ...
    'dimension', 'dual_grid_flag', 'origin', 'size'])
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            View((['global_release_data_flag'], [], ['dimension',
            'dual_grid_flag', 'origin', 'size']),
            title='Edit HyperOctree properties', scrollable=True, resizable=True,
            handler=TVTKBaseHandler,
            buttons=['OK', 'Cancel'])
            return view
