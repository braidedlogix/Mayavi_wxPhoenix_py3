...
class LongLongArray(DataArray):
    ...
    def get_typed_tuple(self, *args):
        ...
        C++: void GetTypedTuple(IdType i, long long *tuple)"""
    ...
    def set_typed_tuple(self, *args):
        ...
        C++: void SetTypedTuple(IdType i, const long long *tuple)"""
    ...
    def get_value(self, *args):
        """
        V.get_value(int) -> int
        C++: long long GetValue(IdType id)"""
    ...
    def set_value(self, *args):
        """
        V.set_value(int, int)
        C++: void SetValue(IdType id, long long value)"""
    ...
    def get_pointer(self, *args):
        ...
        C++: long long *GetPointer(IdType id)"""
    ...
    def insert_next_typed_tuple(self, *args):
        ...
        C++: IdType InsertNextTypedTuple(const long long *tuple)"""
    ...
    def insert_next_value(self, *args):
        ...
        C++: IdType InsertNextValue(long long f)"""
    ...
    def insert_typed_tuple(self, *args):
        ...
        C++: void InsertTypedTuple(IdType i, const long long *tuple)"""
    ...
    def insert_value(self, *args):
        ...
        C++: void InsertValue(IdType id, long long f)"""
    ...
    def write_pointer(self, *args):
        ...
        C++: long long *WritePointer(IdType id, IdType number)"""
