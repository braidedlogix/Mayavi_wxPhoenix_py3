...
class UniformGridGhostDataGenerator(DataSetGhostGenerator):
    """
    UniformGridGhostDataGenerator -  A concrete implementation of
    ...
    For a distributed
     data-set see PUniformGridGhostDataGenerator.
    ...
    @warning
       ...
       The input multi-block dataset must:
         ...
         Each block must be an instance of UniformGrid 
    ...
    @sa
     DataSetGhostGenerator, PUniformGhostDataGenerator
    
    """
    def __init__(self, obj=None, update=True, **traits):
        tvtk_base.TVTKBase.__init__(self, vtk.vtkUniformGridGhostDataGenerator, obj, update, **traits)
    ...
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(UniformGridGhostDataGenerator, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            View((Item("handler._full_traits_list",show_label=False)),
            title='Edit UniformGridGhostDataGenerator properties', scrollable=True, resizable=True,
