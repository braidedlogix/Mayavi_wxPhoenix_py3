...
class ImagePlaneWidget(PolyDataSourceWidget):
    ...
    this class. Based on the Python slice_plane_factory from Atamai, Inc.
    ...
    tvtk_base.TraitRevPrefixMap({'x_axes': 0, 'y_axes': 1, 'z_axes': 2}), help=\
        """
    ...
    tvtk_base.TraitRevPrefixMap({'linear': 1, 'cubic': 2, 'nearest_neighbour': 0}), help=\
        """
    ...
    origin = traits.Array(enter_set=True, auto_set=False, shape=(3,), dtype=float, value=(0.0, -0.5, -0.5), cols=3, help=\
        """
    ...
    point1 = traits.Array(enter_set=True, auto_set=False, shape=(3,), dtype=float, value=(0.0, 0.5, -0.5), cols=3, help=\
        """
    ...
    point2 = traits.Array(enter_set=True, auto_set=False, shape=(3,), dtype=float, value=(0.0, -0.5, 0.5), cols=3, help=\
        """
    ...
    _updateable_traits_ = \
    (('display_text', 'GetDisplayText'), ('interaction',
    'GetInteraction'), ('restrict_plane_to_volume',
    'GetRestrictPlaneToVolume'), ('texture_interpolate',
    'GetTextureInterpolate'), ('texture_visibility',
    'GetTextureVisibility'), ('use_continuous_cursor',
    'GetUseContinuousCursor'), ('user_controlled_lookup_table',
    'GetUserControlledLookupTable'), ('enabled', 'GetEnabled'),
    ('key_press_activation', 'GetKeyPressActivation'), ('picking_managed',
    'GetPickingManaged'), ('debug', 'GetDebug'),
    ('global_warning_display', 'GetGlobalWarningDisplay'),
    ('plane_orientation', 'GetPlaneOrientation'), ('reslice_interpolate',
    'GetResliceInterpolate'), ('left_button_action',
    'GetLeftButtonAction'), ('left_button_auto_modifier',
    'GetLeftButtonAutoModifier'), ('margin_size_x', 'GetMarginSizeX'),
    ('margin_size_y', 'GetMarginSizeY'), ('middle_button_action',
    'GetMiddleButtonAction'), ('middle_button_auto_modifier',
    'GetMiddleButtonAutoModifier'), ('origin', 'GetOrigin'), ('point1',
    'GetPoint1'), ('point2', 'GetPoint2'), ('right_button_action',
    'GetRightButtonAction'), ('right_button_auto_modifier',
    'GetRightButtonAutoModifier'), ('slice_index', 'GetSliceIndex'),
    ('slice_position', 'GetSlicePosition'), ('handle_size',
    ...
    'interaction', 'key_press_activation', 'picking_managed',
    'restrict_plane_to_volume', 'texture_interpolate',
    'texture_visibility', 'use_continuous_cursor',
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            View((['display_text', 'enabled', 'interaction',
            'key_press_activation', 'picking_managed', 'restrict_plane_to_volume',
