...
from tvtk.tvtk_classes.float_array import FloatArray


class TypeFloat32Array(FloatArray):
    """
    TypeFloat32Array - dynamic, self-adjusting array of TypeFloat32
    
    Superclass: FloatArray
    
    TypeFloat32Array is an array of values of type TypeFloat32.  It
    ...
    def __init__(self, obj=None, update=True, **traits):
        tvtk_base.TVTKBase.__init__(self, vtk.vtkTypeFloat32Array, obj, update, **traits)
    ...
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(TypeFloat32Array, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            View((Item("handler._full_traits_list",show_label=False)),
            title='Edit TypeFloat32Array properties', scrollable=True, resizable=True,
