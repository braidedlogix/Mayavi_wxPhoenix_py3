...
class SliderWidget(AbstractWidget):
    ...
    translates VTK events into the SliderWidget's widget events:
    ...
    the SliderWidget invokes the following VTK events on itself (which
    ...
    ('animation_mode', 'GetAnimationMode'), ('number_of_animation_steps',
    'GetNumberOfAnimationSteps'), ('priority', 'GetPriority'),
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            'picking_managed', 'process_events'], ['animation_mode'],
            ['key_press_activation_value', 'number_of_animation_steps',
            'priority']),
            title='Edit SliderWidget properties', scrollable=True, resizable=True,
            handler=TVTKBaseHandler,
            buttons=['OK', 'Cancel'])
