...
class BalloonRepresentation(WidgetRepresentation):
    ...
    tvtk_base.TraitRevPrefixMap({'text_bottom': 3, 'image_top': 3, 'image_bottom': 2, 'image_left': 0, 'image_right': 1, 'text_left': 1, 'text_right': 0, 'text_top': 2}), help=\
        """
    ...
    image_size = traits.Array(enter_set=True, auto_set=False, shape=(2,), dtype=int, value=(50, 50), cols=2, help=\
        """
    ...
    offset = traits.Array(enter_set=True, auto_set=False, shape=(2,), dtype=int, value=(15, -30), cols=2, help=\
        """
    ...
    'GetGlobalWarningDisplay'), ('balloon_layout', 'GetBalloonLayout'),
    ('balloon_text', 'GetBalloonText'), ('image_size', 'GetImageSize'),
    ('offset', 'GetOffset'), ('padding', 'GetPadding'), ('handle_size',
    ...
    'balloon_layout', 'balloon_text', 'estimated_render_time',
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            'visibility'], ['balloon_layout'], ['balloon_text',
