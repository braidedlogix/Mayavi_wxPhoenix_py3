...
class ApplyColors(PassInputTypeAlgorithm):
    ...
    cell_color_output_array_name = traits.String('vtkApplyColors color', enter_set=True, auto_set=False, help=\
        """
    ...
    point_color_output_array_name = traits.String('vtkApplyColors color', enter_set=True, auto_set=False, help=\
        """
    ...
    ('default_point_color', 'GetDefaultPointColor'),
    ...
    ('selected_point_opacity', 'GetSelectedPointOpacity'), ('progress',
