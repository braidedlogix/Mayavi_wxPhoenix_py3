...
class ContinuousValueWidget(AbstractWidget):
    ...
    translates VTK events into the ContinuousValueWidget's widget
    events:
    ...
    the ContinuousValueWidget invokes the following VTK events on
    ...
    def _get_continuous_value_widget_representation(self):
        return wrap_vtk(self._vtk_obj.GetContinuousValueWidgetRepresentation())
    continuous_value_widget_representation = traits.Property(_get_continuous_value_widget_representation, help=\
        """
        Return the representation as a
        ContinuousValueWidgetRepresentation.
        """
    )
    ...
    'process_events', 'key_press_activation_value', 'priority', 'value'])
