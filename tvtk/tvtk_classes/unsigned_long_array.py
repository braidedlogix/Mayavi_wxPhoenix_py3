...
class UnsignedLongArray(DataArray):
    """
    UnsignedLongArray - dynamic, self-adjusting array of unsigned long
    
    Superclass: DataArray
    
    UnsignedLongArray is an array of values of type unsigned long. It
    ...
    UTypeInt64Array to this class.
    
    """
    def __init__(self, obj=None, update=True, **traits):
        tvtk_base.TVTKBase.__init__(self, vtk.vtkUnsignedLongArray, obj, update, **traits)
    ...
    def get_typed_tuple(self, *args):
        ...
        C++: void GetTypedTuple(IdType i, unsigned long *tuple)"""
    ...
    def set_typed_tuple(self, *args):
        ...
        C++: void SetTypedTuple(IdType i, const unsigned long *tuple)"""
    ...
    def get_value(self, *args):
        """
        V.get_value(int) -> int
        C++: unsigned long GetValue(IdType id)"""
    ...
    def set_value(self, *args):
        """
        V.set_value(int, int)
        C++: void SetValue(IdType id, unsigned long value)"""
    ...
    def get_pointer(self, *args):
        ...
        C++: unsigned long *GetPointer(IdType id)"""
    ...
    def insert_next_typed_tuple(self, *args):
        ...
        C++: IdType InsertNextTypedTuple(const unsigned long *tuple)"""
    ...
    def insert_next_value(self, *args):
        ...
        C++: IdType InsertNextValue(unsigned long f)"""
    ...
    def insert_value(self, *args):
        ...
        C++: void InsertValue(IdType id, unsigned long f)"""
    ...
    def write_pointer(self, *args):
        ...
        C++: unsigned long *WritePointer(IdType id, IdType number)"""
    ...
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(UnsignedLongArray, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            View((Item("handler._full_traits_list",show_label=False)),
            title='Edit UnsignedLongArray properties', scrollable=True, resizable=True,
