...
class DataObjectGenerator(DataObjectAlgorithm):
    ...
    program = traits.String('ID1', enter_set=True, auto_set=False, help=\
        """
    ...
    ('global_warning_display', 'GetGlobalWarningDisplay'), ('program',
    'GetProgram'), ('progress', 'GetProgress'), ('progress_text',
