...
class KMeansStatistics(StatisticsAlgorithm):
    ...
    * Derive:  An additional Table is stored in the multiblock dataset
    output on port OUTPUT_MODEL. This table contains columns that store
      for each run: the run_id, number of clusters, total error for all
    ...
    * Assess: This requires a multiblock dataset (as computed from Learn
    ...
    k_values_array_name = traits.String('K', enter_set=True, auto_set=False, help=\
        """
    ...
    ('k_values_array_name', 'GetKValuesArrayName'), ('max_num_iterations',
    'GetMaxNumIterations'), ('tolerance', 'GetTolerance'),
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            View(([], [], ['assess_option', 'default_number_of_clusters',
            'derive_option', 'k_values_array_name', 'learn_option',
