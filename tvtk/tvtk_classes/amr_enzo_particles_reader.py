...
class AMREnzoParticlesReader(AMRBaseParticlesReader):
    """
    AMREnzoParticlesReader -  A concrete instance of the
    AMRBaseParticlesReader which provides
    ...
    'GetGlobalWarningDisplay'), ('particle_type', 'GetParticleType'),
    ('file_name', 'GetFileName'), ('frequency', 'GetFrequency'),
