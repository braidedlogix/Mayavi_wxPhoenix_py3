...
class Property2D(Object):
    ...
    'GetGlobalWarningDisplay'), ('display_location',
    'GetDisplayLocation'), ('color', 'GetColor'), ('line_stipple_pattern',
    'GetLineStipplePattern'), ('line_stipple_repeat_factor',
    'GetLineStippleRepeatFactor'), ('line_width', 'GetLineWidth'),
    ('opacity', 'GetOpacity'), ('point_size', 'GetPointSize'),
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            View(([], ['display_location'], ['color', 'line_stipple_pattern',
