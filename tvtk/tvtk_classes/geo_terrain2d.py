...
class GeoTerrain2D(GeoTerrain):
    ...
    'GetGlobalWarningDisplay'), ('location_tolerance',
    'GetLocationTolerance'), ('texture_tolerance', 'GetTextureTolerance'),
    ('max_level', 'GetMaxLevel'), ('origin', 'GetOrigin'),
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            View(([], [], ['location_tolerance', 'max_level', 'origin',
            'texture_tolerance']),
            title='Edit GeoTerrain2D properties', scrollable=True, resizable=True,
            handler=TVTKBaseHandler,
            buttons=['OK', 'Cancel'])
