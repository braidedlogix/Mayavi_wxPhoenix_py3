...
class XMLPolyDataWriter(XMLUnstructuredDataWriter):
    """
    XMLPolyDataWriter - Write VTK XML poly_data files.
    
    Superclass: XMLUnstructuredDataWriter
    
    XMLPolyDataWriter writes the VTK XML poly_data file format.  One
    ...
    def __init__(self, obj=None, update=True, **traits):
        tvtk_base.TVTKBase.__init__(self, vtk.vtkXMLPolyDataWriter, obj, update, **traits)
    ...
    ('write_piece', 'GetWritePiece'), ('block_size', 'GetBlockSize'),
    ('file_name', 'GetFileName'), ('number_of_time_steps',
    'GetNumberOfTimeSteps'), ('progress', 'GetProgress'),
    ...
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(XMLPolyDataWriter, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            View((Item("handler._full_traits_list",show_label=False)),
            title='Edit XMLPolyDataWriter properties', scrollable=True, resizable=True,
            ...
            'number_of_time_steps', 'write_piece']),
            title='Edit XMLPolyDataWriter properties', scrollable=True, resizable=True,
            handler=TVTKBaseHandler,
            buttons=['OK', 'Cancel'])
            return view
