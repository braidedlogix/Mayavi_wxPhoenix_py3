...
class InteractorStyleUnicam(InteractorStyle):
    ...
    world_up_vector = traits.Array(enter_set=True, auto_set=False, shape=(3,), dtype=float, value=(0.0, 0.0, 1.0), cols=3, help=\
        """
    ...
    ('world_up_vector', 'GetWorldUpVector'), ('mouse_wheel_motion_factor',
