...
class DSPFilterDefinition(Object):
    ...
    input_variable_name = traits.String('', enter_set=True, auto_set=False, help=\
        """
    ...
    output_variable_name = traits.String('', enter_set=True, auto_set=False, help=\
        """
    ...
    'GetGlobalWarningDisplay'), ('input_variable_name',
    'GetInputVariableName'), ('output_variable_name',
    'GetOutputVariableName'), ('reference_count', 'GetReferenceCount'))
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            View(([], [], ['input_variable_name', 'output_variable_name']),
            title='Edit DSPFilterDefinition properties', scrollable=True, resizable=True,
            handler=TVTKBaseHandler,
            buttons=['OK', 'Cancel'])
            return view
