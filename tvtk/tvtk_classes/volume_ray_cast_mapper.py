...
class VolumeRayCastMapper(VolumeMapper):
    ...
    image_sample_distance = traits.Trait(1.0, traits.Range(0.1, 100.0, enter_set=True, auto_set=False), help=\
        """
    ...
    maximum_image_sample_distance = traits.Trait(10.0, traits.Range(0.1, 100.0, enter_set=True, auto_set=False), help=\
        """
    ...
    minimum_image_sample_distance = traits.Trait(1.0, traits.Range(0.1, 100.0, enter_set=True, auto_set=False), help=\
        """
    ...
    ('scalar_mode', 'GetScalarMode'), ('image_sample_distance',
    'GetImageSampleDistance'), ('maximum_image_sample_distance',
    'GetMaximumImageSampleDistance'), ('minimum_image_sample_distance',
    'GetMinimumImageSampleDistance'), ('number_of_threads',
    'GetNumberOfThreads'), ('sample_distance', 'GetSampleDistance'),
    ...
    'scalar_mode', 'average_ip_scalar_range', 'image_sample_distance',
