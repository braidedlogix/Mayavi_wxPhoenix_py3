...
class MINCImageWriter(ImageWriter):
    ...
    @sa
    MINCImageReader MINCImageAttributes@par Thanks: Thanks to David
    ...
    _updateable_traits_ = \
    (('strict_validation', 'GetStrictValidation'), ('abort_execute',
    'GetAbortExecute'), ('release_data_flag', 'GetReleaseDataFlag'),
    ('debug', 'GetDebug'), ('global_warning_display',
    'GetGlobalWarningDisplay'), ('file_name', 'GetFileName'),
    ('history_addition', 'GetHistoryAddition'), ('rescale_intercept',
    'GetRescaleIntercept'), ('rescale_slope', 'GetRescaleSlope'),
    ('file_dimensionality', 'GetFileDimensionality'), ('file_pattern',
    'GetFilePattern'), ('file_prefix', 'GetFilePrefix'), ('progress',
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            View((['strict_validation'], [], ['file_dimensionality', 'file_name',
            'file_pattern', 'file_prefix', 'history_addition',
