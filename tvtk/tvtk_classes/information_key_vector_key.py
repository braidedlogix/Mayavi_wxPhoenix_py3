...
class InformationKeyVectorKey(InformationKey):
    ...
    def make_key(self, *args):
        """
        V.make_key(string, string) -> InformationKeyVectorKey
        C++: static InformationKeyVectorKey *MakeKey(const char *name,
            const char *location)
        This method simply returns a new InformationKeyVectorKey,
