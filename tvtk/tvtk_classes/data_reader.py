...
class DataReader(Algorithm):
    ...
    input_array = traits.Property(_get_input_array, _set_input_array, help=\
        ...
        If set, this array has precedence over input_string. Use this
    ...
    file_major_version = traits.Property(_get_file_major_version, help=\
        """
    ...
    file_minor_version = traits.Property(_get_file_minor_version, help=\
        """
        Return major and minor version of the file. Returns version 3.0
        if the version cannot be read from file.
        """
    ...
    def read_field_data(self, *args):
        """
        V.read_field_data(FieldType) -> FieldData
        C++: FieldData *ReadFieldData(
            FieldType fieldType=DataReader::FIELD_DATA)
        Helper functions for reading data.
        """
