...
class ContourFilter(PolyDataAlgorithm):
    """
    ContourFilter - generate isosurfaces/isolines from scalar values
    ...
    compute_normals = tvtk_base.true_bool_trait(help=\
        ...
        On for ImageData, RectilinearGrid, StructuredGrid, and
        UnstructuredGrid inputs, and Off for all others. This default
    ...
    'array_component', 'number_of_contours', 'output_points_precision',
    'progress_text'])
    
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(ContourFilter, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            View((Item("handler._full_traits_list",show_label=False)),
            title='Edit ContourFilter properties', scrollable=True, resizable=True,
            ...
            'generate_triangles', 'use_scalar_tree'], [], ['array_component',
