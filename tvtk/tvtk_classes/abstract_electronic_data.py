...
class AbstractElectronicData(DataObject):
    ...
    electron_density = traits.Property(_get_electron_density, help=\
        """
    ...
    homo = traits.Property(_get_homo, help=\
        """
    ...
    homo_orbital_number = traits.Property(_get_homo_orbital_number, help=\
        """
    ...
    lumo = traits.Property(_get_lumo, help=\
        """
    ...
    lumo_orbital_number = traits.Property(_get_lumo_orbital_number, help=\
        """
    ...
    number_of_electrons = traits.Property(_get_number_of_electrons, help=\
        """
    ...
    number_of_m_os = traits.Property(_get_number_of_m_os, help=\
        """
    ...
    padding = traits.Property(_get_padding, help=\
        """
    ...
    def is_homo(self, *args):
        """
        V.is_homo(int) -> bool
        C++: bool IsHOMO(IdType orbitalNumber)
    ...
    def is_lumo(self, *args):
        """
        V.is_lumo(int) -> bool
        C++: bool IsLUMO(IdType orbitalNumber)
