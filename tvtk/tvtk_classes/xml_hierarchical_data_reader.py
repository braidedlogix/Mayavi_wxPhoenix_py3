...
from tvtk.tvtk_classes.xml_multi_group_data_reader import XMLMultiGroupDataReader


class XMLHierarchicalDataReader(XMLMultiGroupDataReader):
    """
    XMLHierarchicalDataReader - Reader for hierarchical datasets
    
    Superclass: XMLMultiGroupDataReader
    
    XMLHierarchicalDataReader reads the VTK XML hierarchical data file
    ...
    def __init__(self, obj=None, update=True, **traits):
        tvtk_base.TVTKBase.__init__(self, vtk.vtkXMLHierarchicalDataReader, obj, update, **traits)
    ...
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(XMLHierarchicalDataReader, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            View((Item("handler._full_traits_list",show_label=False)),
            title='Edit XMLHierarchicalDataReader properties', scrollable=True, resizable=True,
