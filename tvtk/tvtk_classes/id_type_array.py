...
class IdTypeArray(DataArray):
    """
    IdTypeArray - dynamic, self-adjusting array of IdType
    
    Superclass: DataArray
    
    IdTypeArray is an array of values of type IdType. It provides
    methods for insertion and retrieval of values and will automatically
    resize itself to hold new data.
    
    """
    def __init__(self, obj=None, update=True, **traits):
        tvtk_base.TVTKBase.__init__(self, vtk.vtkIdTypeArray, obj, update, **traits)
    ...
    def get_typed_tuple(self, *args):
        ...
        C++: void GetTypedTuple(IdType i, IdType *tuple)"""
    ...
    def set_typed_tuple(self, *args):
        ...
        C++: void SetTypedTuple(IdType i, const IdType *tuple)"""
    ...
    def set_value(self, *args):
        """
        V.set_value(int, int)
        C++: void SetValue(IdType id, IdType value)"""
    ...
    def insert_next_typed_tuple(self, *args):
        ...
        C++: IdType InsertNextTypedTuple(const IdType *tuple)"""
    ...
    def insert_next_value(self, *args):
        ...
        C++: IdType InsertNextValue(IdType f)"""
    ...
    def insert_typed_tuple(self, *args):
        ...
        C++: void InsertTypedTuple(IdType i, const IdType *tuple)"""
    ...
    def insert_value(self, *args):
        ...
        C++: void InsertValue(IdType id, IdType f)"""
    ...
    def write_pointer(self, *args):
        ...
        C++: IdType *WritePointer(IdType id, IdType number)"""
    ...
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(IdTypeArray, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            View((Item("handler._full_traits_list",show_label=False)),
            title='Edit IdTypeArray properties', scrollable=True, resizable=True,
