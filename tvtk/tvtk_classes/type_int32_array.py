...
from tvtk.tvtk_classes.int_array import IntArray


class TypeInt32Array(IntArray):
    """
    TypeInt32Array - dynamic, self-adjusting array of TypeInt32
    
    Superclass: IntArray
    
    TypeInt32Array is an array of values of type TypeInt32.  It
    ...
    def __init__(self, obj=None, update=True, **traits):
        tvtk_base.TVTKBase.__init__(self, vtk.vtkTypeInt32Array, obj, update, **traits)
    ...
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(TypeInt32Array, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            View((Item("handler._full_traits_list",show_label=False)),
            title='Edit TypeInt32Array properties', scrollable=True, resizable=True,
