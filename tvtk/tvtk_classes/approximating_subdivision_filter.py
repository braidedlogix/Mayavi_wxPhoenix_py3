...
class ApproximatingSubdivisionFilter(PolyDataAlgorithm):
    """
    ApproximatingSubdivisionFilter - generate a subdivision surface
    using an Approximating Scheme
    
    Superclass: PolyDataAlgorithm
    
    ApproximatingSubdivisionFilter is an abstract class that defines
    ...
    def __init__(self, obj=None, update=True, **traits):
        tvtk_base.TVTKBase.__init__(self, vtk.vtkApproximatingSubdivisionFilter, obj, update, **traits)
    ...
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(ApproximatingSubdivisionFilter, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            View((Item("handler._full_traits_list",show_label=False)),
            title='Edit ApproximatingSubdivisionFilter properties', scrollable=True, resizable=True,
