...
class IntArray(DataArray):
    """
    IntArray - dynamic, self-adjusting array of int
    
    Superclass: DataArray
    
    IntArray is an array of values of type int.  It provides methods
    ...
    integers is needed, prefer TypeInt32Array to this class.
    
    """
    def __init__(self, obj=None, update=True, **traits):
        tvtk_base.TVTKBase.__init__(self, vtk.vtkIntArray, obj, update, **traits)
    ...
    def get_typed_tuple(self, *args):
        ...
        C++: void GetTypedTuple(IdType i, int *tuple)"""
    ...
    def set_typed_tuple(self, *args):
        ...
        C++: void SetTypedTuple(IdType i, const int *tuple)"""
    ...
    def insert_next_typed_tuple(self, *args):
        ...
        C++: IdType InsertNextTypedTuple(const int *tuple)"""
    ...
    def insert_next_value(self, *args):
        ...
        C++: IdType InsertNextValue(int f)"""
    ...
    def insert_typed_tuple(self, *args):
        ...
        C++: void InsertTypedTuple(IdType i, const int *tuple)"""
    ...
    def insert_value(self, *args):
        ...
        C++: void InsertValue(IdType id, int f)"""
    ...
    def write_pointer(self, *args):
        ...
        C++: int *WritePointer(IdType id, IdType number)"""
    ...
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(IntArray, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            View((Item("handler._full_traits_list",show_label=False)),
            title='Edit IntArray properties', scrollable=True, resizable=True,
