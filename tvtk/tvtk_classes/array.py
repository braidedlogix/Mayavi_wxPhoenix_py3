...
class Array(Object):
    ...
    name = traits.String('', enter_set=True, auto_set=False, help=\
        """
        Sets the array name.
        """
    )
    ...
    'GetGlobalWarningDisplay'), ('dimension_label', 'GetDimensionLabel'),
    ('name', 'GetName'), ('variant_value', 'GetVariantValue'),
    ('variant_value_n', 'GetVariantValueN'), ('reference_count',
    'GetReferenceCount'))
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            View(([], [], ['dimension_label', 'name', 'variant_value',
            'variant_value_n']),
            title='Edit Array properties', scrollable=True, resizable=True,
            handler=TVTKBaseHandler,
            buttons=['OK', 'Cancel'])
