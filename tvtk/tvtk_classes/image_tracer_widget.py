...
class ImageTracerWidget(ThreeDWidget):
    ...
    tvtk_base.TraitRevPrefixMap({'z_axes': 2, 'x_axes': 0, 'y_axes': 1}), help=\
        """
    ...
    _updateable_traits_ = \
    (('auto_close', 'GetAutoClose'), ('handle_left_mouse_button',
    'GetHandleLeftMouseButton'), ('handle_middle_mouse_button',
    'GetHandleMiddleMouseButton'), ('handle_right_mouse_button',
    'GetHandleRightMouseButton'), ('interaction', 'GetInteraction'),
    ('project_to_plane', 'GetProjectToPlane'), ('snap_to_image',
    'GetSnapToImage'), ('enabled', 'GetEnabled'), ('key_press_activation',
    'GetKeyPressActivation'), ('picking_managed', 'GetPickingManaged'),
    ('debug', 'GetDebug'), ('global_warning_display',
    'GetGlobalWarningDisplay'), ('projection_normal',
    'GetProjectionNormal'), ('capture_radius', 'GetCaptureRadius'),
    ('image_snap_type', 'GetImageSnapType'), ('projection_position',
    ...
    'picking_managed', 'project_to_plane', 'snap_to_image',
    'projection_normal', 'capture_radius', 'handle_size',
    'image_snap_type', 'key_press_activation_value', 'place_factor',
    'priority', 'projection_position'])
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            View((['auto_close', 'enabled', 'handle_left_mouse_button',
