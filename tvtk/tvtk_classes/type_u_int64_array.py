...
from tvtk.tvtk_classes.unsigned_long_long_array import UnsignedLongLongArray


class TypeUInt64Array(UnsignedLongLongArray):
    """
    TypeUInt64Array - dynamic, self-adjusting array of TypeUInt64
    
    Superclass: UnsignedLongLongArray
    
    TypeUInt64Array is an array of values of type TypeUInt64.  It
    ...
    def __init__(self, obj=None, update=True, **traits):
        tvtk_base.TVTKBase.__init__(self, vtk.vtkTypeUInt64Array, obj, update, **traits)
    ...
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(TypeUInt64Array, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            View((Item("handler._full_traits_list",show_label=False)),
            title='Edit TypeUInt64Array properties', scrollable=True, resizable=True,
