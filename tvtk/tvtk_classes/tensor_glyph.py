...
class TensorGlyph(PolyDataAlgorithm):
    ...
    source = traits.Property(_get_source, help=\
        ...
        See set_source_connection for connecting the pipeline.
        """
    )
    ...
    _updateable_traits_ = \
    (('clamp_scaling', 'GetClampScaling'), ('color_glyphs',
    'GetColorGlyphs'), ('extract_eigenvalues', 'GetExtractEigenvalues'),
    ('scaling', 'GetScaling'), ('symmetric', 'GetSymmetric'),
    ('three_glyphs', 'GetThreeGlyphs'), ('abort_execute',
    'GetAbortExecute'), ('release_data_flag', 'GetReleaseDataFlag'),
    ('debug', 'GetDebug'), ('global_warning_display',
    'GetGlobalWarningDisplay'), ('color_mode', 'GetColorMode'), ('length',
    'GetLength'), ('max_scale_factor', 'GetMaxScaleFactor'),
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            View((['clamp_scaling', 'color_glyphs', 'extract_eigenvalues',
            'scaling', 'symmetric', 'three_glyphs'], ['color_mode'], ['length',
