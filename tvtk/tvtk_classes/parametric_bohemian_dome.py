...
class ParametricBohemianDome(ParametricFunction):
    ...
    a = traits.Float(0.5, enter_set=True, auto_set=False, help=\
        """
    ...
    b = traits.Float(1.5, enter_set=True, auto_set=False, help=\
        """
    ...
    c = traits.Float(1.0, enter_set=True, auto_set=False, help=\
        """
    ...
    'GetC'), ('maximum_u', 'GetMaximumU'), ('maximum_v', 'GetMaximumV'),
