...
class ArrayCalculator(DataSetAlgorithm):
    ...
    result_normals = tvtk_base.false_bool_trait(help=\
        """
        ...
        are selected using attribute_mode.
        """
    )
    ...
    tvtk_base.TraitRevPrefixMap({'default': 0, 'use_cell_data': 2, 'use_edge_data': 4, 'use_point_data': 1, 'use_vertex_data': 3}), help=\
        """
    ...
    result_array_name = traits.String('resultArray', enter_set=True, auto_set=False, help=\
        """
    ...
    selected_scalar_components = traits.Property(_get_selected_scalar_components, help=\
        """
        Methods to get information about the current variables.
        """
    )
    ...
    def get_selected_vector_components(self, *args):
        """
        V.get_selected_vector_components(int) -> (int, ...)
    ...
    ('attribute_mode', 'GetAttributeMode'), ('function', 'GetFunction'),
    ...
    'attribute_mode', 'function', 'progress_text', 'replacement_value',
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            View((['coordinate_results', 'replace_invalid_values',
            'result_normals', 'result_t_coords'], ['attribute_mode'], ['function',
