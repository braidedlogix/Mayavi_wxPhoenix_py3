...
class ClipPolyData(PolyDataAlgorithm):
    ...
    @sa
    ImplicitFunction Cutter ClipVolume ExtractGeometry
    ...
    generate_clip_scalars = tvtk_base.false_bool_trait(help=\
        ...
        implicit function an error will be reported. generate_clip_scalars
        is off by default.
        """
    )
    ...
    generate_clipped_output = tvtk_base.false_bool_trait(help=\
        ...
        generate_clipped_output is off by default.
        """
    )
    ...
    ('output_points_precision', 'GetOutputPointsPrecision'), ('value',
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            'inside_out'], [], ['output_points_precision', 'value']),
            title='Edit ClipPolyData properties', scrollable=True, resizable=True,
            handler=TVTKBaseHandler,
            buttons=['OK', 'Cancel'])
            return view
