...
from tvtk.tvtk_classes.xmlp_uniform_grid_amr_writer import XMLPUniformGridAMRWriter


class XMLPHierarchicalBoxDataWriter(XMLPUniformGridAMRWriter):
    """
    XMLPHierarchicalBoxDataWriter - parallel writer for
    HierarchicalBoxDataSet for backwards compatibility.
    
    Superclass: XMLPUniformGridAMRWriter
    
    XMLPHierarchicalBoxDataWriter is an empty subclass of
    XMLPUniformGridAMRWriter for backwards compatibility.
    
    """
    def __init__(self, obj=None, update=True, **traits):
        tvtk_base.TVTKBase.__init__(self, vtk.vtkXMLPHierarchicalBoxDataWriter, obj, update, **traits)
    ...
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(XMLPHierarchicalBoxDataWriter, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            View((Item("handler._full_traits_list",show_label=False)),
            title='Edit XMLPHierarchicalBoxDataWriter properties', scrollable=True, resizable=True,
