...
from tvtk.tvtk_classes.unsigned_char_array import UnsignedCharArray


class TypeUInt8Array(UnsignedCharArray):
    """
    TypeUInt8Array - dynamic, self-adjusting array of TypeUInt8
    
    Superclass: UnsignedCharArray
    
    TypeUInt8Array is an array of values of type TypeUInt8.  It
    ...
    def __init__(self, obj=None, update=True, **traits):
        tvtk_base.TVTKBase.__init__(self, vtk.vtkTypeUInt8Array, obj, update, **traits)
    ...
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(TypeUInt8Array, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            View((Item("handler._full_traits_list",show_label=False)),
            title='Edit TypeUInt8Array properties', scrollable=True, resizable=True,
