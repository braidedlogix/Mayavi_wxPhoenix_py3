...
class ClosedSurfacePointPlacer(PointPlacer):
    ...
    minimum_distance = traits.Trait(0.0, traits.Range(0.0, 1e+299, enter_set=True, auto_set=False), help=\
        """
    ...
    'GetGlobalWarningDisplay'), ('minimum_distance',
    'GetMinimumDistance'), ('pixel_tolerance', 'GetPixelTolerance'),
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            View(([], [], ['minimum_distance', 'pixel_tolerance',
            'world_tolerance']),
            title='Edit ClosedSurfacePointPlacer properties', scrollable=True, resizable=True,
            handler=TVTKBaseHandler,
            buttons=['OK', 'Cancel'])
