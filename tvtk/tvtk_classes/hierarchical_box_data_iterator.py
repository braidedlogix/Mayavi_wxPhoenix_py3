...
from tvtk.tvtk_classes.uniform_grid_amr_data_iterator import UniformGridAMRDataIterator


class HierarchicalBoxDataIterator(UniformGridAMRDataIterator):
    """
    HierarchicalBoxDataIterator -  Empty class for backwards
    compatibility.
    
    Superclass: UniformGridAMRDataIterator
