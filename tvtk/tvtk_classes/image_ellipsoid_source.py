...
class ImageEllipsoidSource(ImageAlgorithm):
    ...
    center = traits.Array(enter_set=True, auto_set=False, shape=(3,), dtype=float, value=(128.0, 128.0, 0.0), cols=3, help=\
        """
    ...
    radius = traits.Array(enter_set=True, auto_set=False, shape=(3,), dtype=float, value=(70.0, 70.0, 70.0), cols=3, help=\
        """
    ...
    whole_extent = traits.Array(enter_set=True, auto_set=False, shape=(6,), dtype=int, value=(0, 255, 0, 255, 0, 0), cols=3, help=\
        """
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            View(([], [], ['center', 'in_value', 'out_value', 'radius',
            'whole_extent']),
            title='Edit ImageEllipsoidSource properties', scrollable=True, resizable=True,
            handler=TVTKBaseHandler,
            buttons=['OK', 'Cancel'])
