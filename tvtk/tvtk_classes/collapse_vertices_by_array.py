...
class CollapseVerticesByArray(GraphAlgorithm):
    ...
    edges_collapsed_array = traits.String('EdgesCollapsedCountArray', enter_set=True, auto_set=False, help=\
        """
    ...
    vertices_collapsed_array = traits.String('VerticesCollapsedCountArray', enter_set=True, auto_set=False, help=\
        """
