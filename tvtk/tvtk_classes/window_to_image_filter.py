...
class WindowToImageFilter(Algorithm):
    ...
    tvtk_base.TraitRevPrefixMap({'rgb': 3, 'rgba': 4, 'z_buffer': 5}), help=\
        """
    ...
    ('input_buffer_type', 'GetInputBufferType'), ('magnification',
    'GetMagnification'), ('viewport', 'GetViewport'), ('progress',
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            ['input_buffer_type'], ['magnification', 'viewport']),
            title='Edit WindowToImageFilter properties', scrollable=True, resizable=True,
            handler=TVTKBaseHandler,
            buttons=['OK', 'Cancel'])
            return view
