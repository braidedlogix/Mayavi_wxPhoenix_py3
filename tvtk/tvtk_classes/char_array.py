...
class CharArray(DataArray):
    """
    CharArray - dynamic, self-adjusting array of char
    
    Superclass: DataArray
    
    CharArray is an array of values of type char.  It provides methods
    for insertion and retrieval of values and will automatically resize
    itself to hold new data.
    
    """
    def __init__(self, obj=None, update=True, **traits):
        tvtk_base.TVTKBase.__init__(self, vtk.vtkCharArray, obj, update, **traits)
    ...
    def get_typed_tuple(self, *args):
        """
        V.get_typed_tuple(int, [char, ...])
        C++: void GetTypedTuple(IdType i, char *tuple)"""
        ret = self._wrap_call(self._vtk_obj.GetTypedTuple, *args)
        return ret

    def set_typed_tuple(self, *args):
        """
        V.set_typed_tuple(int, (char, ...))
        C++: void SetTypedTuple(IdType i, const char *tuple)"""
        ret = self._wrap_call(self._vtk_obj.SetTypedTuple, *args)
        return ret

    def get_value(self, *args):
        """
        V.get_value(int) -> char
        C++: char GetValue(IdType id)"""
        ret = self._wrap_call(self._vtk_obj.GetValue, *args)
        return ret

    def set_value(self, *args):
        """
        V.set_value(int, char)
        C++: void SetValue(IdType id, char value)"""
    ...
    def get_pointer(self, *args):
        """
        V.get_pointer(int) -> string
        C++: char *GetPointer(IdType id)"""
    ...
    def insert_next_typed_tuple(self, *args):
        """
        V.insert_next_typed_tuple((char, ...)) -> int
        C++: IdType InsertNextTypedTuple(const char *tuple)"""
        ret = self._wrap_call(self._vtk_obj.InsertNextTypedTuple, *args)
        return ret

    def insert_next_value(self, *args):
        """
        V.insert_next_value(char) -> int
        C++: IdType InsertNextValue(char f)"""
        ret = self._wrap_call(self._vtk_obj.InsertNextValue, *args)
        return ret

    def insert_typed_tuple(self, *args):
        """
        V.insert_typed_tuple(int, (char, ...))
        C++: void InsertTypedTuple(IdType i, const char *tuple)"""
        ret = self._wrap_call(self._vtk_obj.InsertTypedTuple, *args)
        return ret

    def insert_value(self, *args):
        """
        V.insert_value(int, char)
        C++: void InsertValue(IdType id, char f)"""
        ret = self._wrap_call(self._vtk_obj.InsertValue, *args)
        return ret

    def write_pointer(self, *args):
        """
        V.write_pointer(int, int) -> string
        C++: char *WritePointer(IdType id, IdType number)"""
    ...
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(CharArray, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            View((Item("handler._full_traits_list",show_label=False)),
            title='Edit CharArray properties', scrollable=True, resizable=True,
