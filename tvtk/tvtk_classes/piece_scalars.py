...
class PieceScalars(DataSetAlgorithm):
    """
    PieceScalars - Sets all cell scalars from the update piece.
    
    Superclass: DataSetAlgorithm
    
    PieceScalars is meant to display which piece is being requested as
    ...
    def __init__(self, obj=None, update=True, **traits):
        tvtk_base.TVTKBase.__init__(self, vtk.vtkPieceScalars, obj, update, **traits)
    ...
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(PieceScalars, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            View((Item("handler._full_traits_list",show_label=False)),
            title='Edit PieceScalars properties', scrollable=True, resizable=True,
