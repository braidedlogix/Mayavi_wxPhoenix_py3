...
class PiecewiseFunctionShiftScale(PiecewiseFunctionAlgorithm):
    ...
    ('position_scale', 'GetPositionScale'), ('position_shift',
    'GetPositionShift'), ('value_scale', 'GetValueScale'), ('value_shift',
    'GetValueShift'), ('progress', 'GetProgress'), ('progress_text',
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            View(([], [], ['position_scale', 'position_shift', 'value_scale',
            'value_shift']),
            title='Edit PiecewiseFunctionShiftScale properties', scrollable=True, resizable=True,
            handler=TVTKBaseHandler,
            buttons=['OK', 'Cancel'])
