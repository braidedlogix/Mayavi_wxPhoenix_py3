...
class TooltipItem(ContextItem):
    ...
    text = traits.String('', enter_set=True, auto_set=False, help=\
        """
    ...
    text_properties = traits.Property(_get_text_properties, help=\
        """
        Get the TextProperty that governs how the tooltip text is
        displayed.
        """
    )
    ...
    'GetGlobalWarningDisplay'), ('position', 'GetPosition'), ('text',
    'GetText'), ('opacity', 'GetOpacity'), ('interactive',
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            View(([], [], ['interactive', 'opacity', 'position', 'text',
            'visible']),
            title='Edit TooltipItem properties', scrollable=True, resizable=True,
            handler=TVTKBaseHandler,
            buttons=['OK', 'Cancel'])
