...
class QuadRotationalExtrusionFilter(MultiBlockDataSetAlgorithm):
    ...
    default_angle = traits.Float(360.0, enter_set=True, auto_set=False, help=\
        """
    ...
    'GetAxis'), ('default_angle', 'GetDefaultAngle'), ('delta_radius',
    'GetDeltaRadius'), ('resolution', 'GetResolution'), ('translation',
