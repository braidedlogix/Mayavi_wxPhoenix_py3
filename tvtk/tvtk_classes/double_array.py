...
class DoubleArray(DataArray):
    """
    DoubleArray - dynamic, self-adjusting array of double
    
    Superclass: DataArray
    
    DoubleArray is an array of values of type double.  It provides
    methods for insertion and retrieval of values and will automatically
    resize itself to hold new data.
    
    """
    def __init__(self, obj=None, update=True, **traits):
        tvtk_base.TVTKBase.__init__(self, vtk.vtkDoubleArray, obj, update, **traits)
    ...
    def get_typed_tuple(self, *args):
        """
        V.get_typed_tuple(int, [float, ...])
        C++: void GetTypedTuple(IdType i, double *tuple)"""
        ret = self._wrap_call(self._vtk_obj.GetTypedTuple, *args)
        return ret

    def set_typed_tuple(self, *args):
        """
        V.set_typed_tuple(int, (float, ...))
        C++: void SetTypedTuple(IdType i, const double *tuple)"""
    ...
    def set_value(self, *args):
        ...
        C++: void SetValue(IdType id, double value)"""
    ...
    def get_pointer(self, *args):
        """
        V.get_pointer(int) -> (float, ...)
        C++: double *GetPointer(IdType id)"""
    ...
    def insert_next_typed_tuple(self, *args):
        """
        V.insert_next_typed_tuple((float, ...)) -> int
        C++: IdType InsertNextTypedTuple(const double *tuple)"""
        ret = self._wrap_call(self._vtk_obj.InsertNextTypedTuple, *args)
        return ret

    def insert_next_value(self, *args):
        """
        V.insert_next_value(float) -> int
        C++: IdType InsertNextValue(double f)"""
        ret = self._wrap_call(self._vtk_obj.InsertNextValue, *args)
        return ret

    def insert_typed_tuple(self, *args):
        """
        V.insert_typed_tuple(int, (float, ...))
        C++: void InsertTypedTuple(IdType i, const double *tuple)"""
        ret = self._wrap_call(self._vtk_obj.InsertTypedTuple, *args)
        return ret

    def insert_value(self, *args):
        """
        V.insert_value(int, float)
        C++: void InsertValue(IdType id, double f)"""
        ret = self._wrap_call(self._vtk_obj.InsertValue, *args)
        return ret

    def write_pointer(self, *args):
        """
        V.write_pointer(int, int) -> (float, ...)
        C++: double *WritePointer(IdType id, IdType number)"""
    ...
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(DoubleArray, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            View((Item("handler._full_traits_list",show_label=False)),
            title='Edit DoubleArray properties', scrollable=True, resizable=True,
