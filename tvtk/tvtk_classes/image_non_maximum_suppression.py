...
class ImageNonMaximumSuppression(ThreadedImageAlgorithm):
    ...
    def set_magnitude_input_data(self, *args):
        """
        V.set_magnitude_input_data(ImageData)
        C++: void SetMagnitudeInputData(ImageData *input)
        Set the magnitude and vector inputs.
        """
        my_args = [deref_vtk(x) for x in args]
        ret = self._wrap_call(self._vtk_obj.SetMagnitudeInputData, *my_args)
        return ret
