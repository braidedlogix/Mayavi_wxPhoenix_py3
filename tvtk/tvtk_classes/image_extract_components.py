...
class ImageExtractComponents(ThreadedImageAlgorithm):
    ...
    components = traits.Array(enter_set=True, auto_set=False, shape=(3,), dtype=int, value=(0, 1, 2), cols=3, help=\
        """
    ...
    'GetSplitMode'), ('components', 'GetComponents'),
    ...
    'release_data_flag', 'split_mode', 'components',
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            View(([], ['split_mode'], ['components', 'desired_bytes_per_piece',
