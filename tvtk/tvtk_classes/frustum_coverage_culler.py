...
class FrustumCoverageCuller(Culler):
    ...
    tvtk_base.TraitRevPrefixMap({'none': 0, 'back_to_front': 2, 'front_to_back': 1}), help=\
        """
    ...
    'GetGlobalWarningDisplay'), ('sorting_style', 'GetSortingStyle'),
    ('maximum_coverage', 'GetMaximumCoverage'), ('minimum_coverage',
    'GetMinimumCoverage'), ('reference_count', 'GetReferenceCount'))
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            View(([], ['sorting_style'], ['maximum_coverage',
            'minimum_coverage']),
            title='Edit FrustumCoverageCuller properties', scrollable=True, resizable=True,
            handler=TVTKBaseHandler,
            buttons=['OK', 'Cancel'])
