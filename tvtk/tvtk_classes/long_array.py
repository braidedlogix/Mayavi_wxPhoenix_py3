...
class LongArray(DataArray):
    """
    LongArray - dynamic, self-adjusting array of long
    
    Superclass: DataArray
    
    LongArray is an array of values of type long.  It provides methods
    ...
    integers is needed, prefer TypeInt32Array to this class.  If an
    array of 64 bit integers is needed, prefer TypeInt64Array to this
    class.
    
    """
    def __init__(self, obj=None, update=True, **traits):
        tvtk_base.TVTKBase.__init__(self, vtk.vtkLongArray, obj, update, **traits)
    ...
    def get_typed_tuple(self, *args):
        ...
        C++: void GetTypedTuple(IdType i, long *tuple)"""
    ...
    def set_typed_tuple(self, *args):
        ...
        C++: void SetTypedTuple(IdType i, const long *tuple)"""
    ...
    def set_value(self, *args):
        """
        V.set_value(int, int)
        C++: void SetValue(IdType id, long value)"""
    ...
    def insert_next_typed_tuple(self, *args):
        ...
        C++: IdType InsertNextTypedTuple(const long *tuple)"""
    ...
    def insert_next_value(self, *args):
        ...
        C++: IdType InsertNextValue(long f)"""
    ...
    def insert_typed_tuple(self, *args):
        ...
        C++: void InsertTypedTuple(IdType i, const long *tuple)"""
    ...
    def insert_value(self, *args):
        ...
        C++: void InsertValue(IdType id, long f)"""
    ...
    def write_pointer(self, *args):
        ...
        C++: long *WritePointer(IdType id, IdType number)"""
    ...
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(LongArray, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            View((Item("handler._full_traits_list",show_label=False)),
            title='Edit LongArray properties', scrollable=True, resizable=True,
