...
class CosmicTreeLayoutStrategy(GraphLayoutStrategy):
    ...
    _updateable_traits_ = \
    (('size_leaf_nodes_only', 'GetSizeLeafNodesOnly'), ('debug',
    'GetDebug'), ('global_warning_display', 'GetGlobalWarningDisplay'),
    ('layout_depth', 'GetLayoutDepth'), ('layout_root', 'GetLayoutRoot'),
    ('node_size_array_name', 'GetNodeSizeArrayName'),
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            View((['size_leaf_nodes_only'], [], ['edge_weight_field',
