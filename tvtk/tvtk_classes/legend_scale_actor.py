...
class LegendScaleActor(Prop):
    ...
    _updateable_traits_ = \
    (('bottom_axis_visibility', 'GetBottomAxisVisibility'),
    ('left_axis_visibility', 'GetLeftAxisVisibility'),
    ('legend_visibility', 'GetLegendVisibility'),
    ('right_axis_visibility', 'GetRightAxisVisibility'),
    ('top_axis_visibility', 'GetTopAxisVisibility'), ('dragable',
    'GetDragable'), ('pickable', 'GetPickable'), ('use_bounds',
    'GetUseBounds'), ('visibility', 'GetVisibility'), ('debug',
    'GetDebug'), ('global_warning_display', 'GetGlobalWarningDisplay'),
    ('label_mode', 'GetLabelMode'), ('bottom_border_offset',
    'GetBottomBorderOffset'), ('corner_offset_factor',
    'GetCornerOffsetFactor'), ('left_border_offset',
    'GetLeftBorderOffset'), ('right_border_offset',
    'GetRightBorderOffset'), ('top_border_offset', 'GetTopBorderOffset'),
    ...
    'use_bounds', 'visibility', 'label_mode', 'bottom_border_offset',
    'corner_offset_factor', 'estimated_render_time', 'left_border_offset',
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            View((['bottom_axis_visibility', 'left_axis_visibility',
