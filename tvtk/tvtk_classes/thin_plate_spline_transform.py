...
class ThinPlateSplineTransform(WarpTransform):
    ...
    tvtk_base.TraitRevPrefixMap({'r2_log_r': 2, 'r': 1}), help=\
        """
    ...
    'GetGlobalWarningDisplay'), ('basis', 'GetBasis'), ('sigma',
    'GetSigma'), ('inverse_iterations', 'GetInverseIterations'),
    ('inverse_tolerance', 'GetInverseTolerance'), ('reference_count',
    'GetReferenceCount'))
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            View(([], ['basis'], ['inverse_iterations', 'inverse_tolerance',
            'sigma']),
            title='Edit ThinPlateSplineTransform properties', scrollable=True, resizable=True,
            handler=TVTKBaseHandler,
            buttons=['OK', 'Cancel'])
