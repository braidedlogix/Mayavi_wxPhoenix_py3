...
class UnsignedLongLongArray(DataArray):
    """
    UnsignedLongLongArray - dynamic, self-adjusting array of unsigned
    long long
    
    Superclass: DataArray
    
    UnsignedLongLongArray is an array of values of type unsigned long
    ...
    unsigned 64 bit integer data array, use TypeUInt64Array instead.
    
    """
    def __init__(self, obj=None, update=True, **traits):
        tvtk_base.TVTKBase.__init__(self, vtk.vtkUnsignedLongLongArray, obj, update, **traits)
    ...
    def get_typed_tuple(self, *args):
        ...
        C++: void GetTypedTuple(IdType i, unsigned long long *tuple)"""
    ...
    def get_value(self, *args):
        """
        V.get_value(int) -> int
        C++: unsigned long long GetValue(IdType id)"""
    ...
    def set_value(self, *args):
        """
        V.set_value(int, int)
        C++: void SetValue(IdType id, unsigned long long value)"""
    ...
    def get_pointer(self, *args):
        ...
        C++: unsigned long long *GetPointer(IdType id)"""
    ...
    def insert_next_value(self, *args):
        ...
        C++: IdType InsertNextValue(unsigned long long f)"""
    ...
    def insert_value(self, *args):
        ...
        C++: void InsertValue(IdType id, unsigned long long f)"""
    ...
    def write_pointer(self, *args):
        ...
        C++: unsigned long long *WritePointer(IdType id,
            IdType number)"""
    ...
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(UnsignedLongLongArray, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            View((Item("handler._full_traits_list",show_label=False)),
            title='Edit UnsignedLongLongArray properties', scrollable=True, resizable=True,
