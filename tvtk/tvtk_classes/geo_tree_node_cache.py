...
class GeoTreeNodeCache(Object):
    ...
    'GetGlobalWarningDisplay'), ('cache_maximum_limit',
    'GetCacheMaximumLimit'), ('cache_minimum_limit',
    'GetCacheMinimumLimit'), ('reference_count', 'GetReferenceCount'))
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            View(([], [], ['cache_maximum_limit', 'cache_minimum_limit']),
            title='Edit GeoTreeNodeCache properties', scrollable=True, resizable=True,
            handler=TVTKBaseHandler,
            buttons=['OK', 'Cancel'])
            return view
