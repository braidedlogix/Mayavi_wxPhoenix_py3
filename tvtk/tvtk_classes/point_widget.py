...
class PointWidget(ThreeDWidget):
    ...
    _updateable_traits_ = \
    (('outline', 'GetOutline'), ('translation_mode',
    'GetTranslationMode'), ('x_shadows', 'GetXShadows'), ('y_shadows',
    'GetYShadows'), ('z_shadows', 'GetZShadows'), ('enabled',
    'GetEnabled'), ('key_press_activation', 'GetKeyPressActivation'),
    ('picking_managed', 'GetPickingManaged'), ('debug', 'GetDebug'),
    ('global_warning_display', 'GetGlobalWarningDisplay'),
    ('hot_spot_size', 'GetHotSpotSize'), ('position', 'GetPosition'),
    ...
    'key_press_activation', 'outline', 'picking_managed',
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            View((['enabled', 'key_press_activation', 'outline',
            'picking_managed', 'translation_mode', 'x_shadows', 'y_shadows',
            'z_shadows'], [], ['handle_size', 'hot_spot_size',
            'key_press_activation_value', 'place_factor', 'position',
            'priority']),
            title='Edit PointWidget properties', scrollable=True, resizable=True,
            handler=TVTKBaseHandler,
            buttons=['OK', 'Cancel'])
