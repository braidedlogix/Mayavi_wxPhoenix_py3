...
from tvtk.tvtk_classes.short_array import ShortArray


class TypeInt16Array(ShortArray):
    """
    TypeInt16Array - dynamic, self-adjusting array of TypeInt16
    
    Superclass: ShortArray
    
    TypeInt16Array is an array of values of type TypeInt16.  It
    ...
    def __init__(self, obj=None, update=True, **traits):
        tvtk_base.TVTKBase.__init__(self, vtk.vtkTypeInt16Array, obj, update, **traits)
    ...
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(TypeInt16Array, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            View((Item("handler._full_traits_list",show_label=False)),
            title='Edit TypeInt16Array properties', scrollable=True, resizable=True,
