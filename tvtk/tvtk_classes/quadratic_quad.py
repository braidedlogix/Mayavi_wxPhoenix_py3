...
class QuadraticQuad(NonLinearCell):
    """
    QuadraticQuad - cell represents a parabolic, 8-node isoparametric
    quad
    ...
    def __init__(self, obj=None, update=True, **traits):
        tvtk_base.TVTKBase.__init__(self, vtk.vtkQuadraticQuad, obj, update, **traits)
    ...
    def interpolation_derivs(self, *args):
        ...
        C++: static void InterpolationDerivs(double pcoords[3],
            double derivs[16])
        @deprecated Replaced by QuadraticQuad::InterpolateDerivs as of
        VTK 5.2
        """
    ...
    def interpolation_functions(self, *args):
        ...
        C++: static void InterpolationFunctions(double pcoords[3],
            double weights[8])
        @deprecated Replaced by QuadraticQuad::InterpolateFunctions as
        of VTK 5.2
        """
    ...
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(QuadraticQuad, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            View((Item("handler._full_traits_list",show_label=False)),
            title='Edit QuadraticQuad properties', scrollable=True, resizable=True,
