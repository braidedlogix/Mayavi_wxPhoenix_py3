...
class ImageToPolyDataFilter(PolyDataAlgorithm):
    ...
    tvtk_base.TraitRevPrefixMap({'polygonalize': 1, 'pixelize': 0, 'run_length': 2}), help=\
        """
    ...
    decimation_error = traits.Trait(1.5, traits.Range(0.0, 1e+299, enter_set=True, auto_set=False), help=\
        """
    ...
    _updateable_traits_ = \
    (('decimation', 'GetDecimation'), ('smoothing', 'GetSmoothing'),
    ('abort_execute', 'GetAbortExecute'), ('release_data_flag',
    'GetReleaseDataFlag'), ('debug', 'GetDebug'),
    ('global_warning_display', 'GetGlobalWarningDisplay'), ('color_mode',
    'GetColorMode'), ('output_style', 'GetOutputStyle'),
    ('decimation_error', 'GetDecimationError'), ('error', 'GetError'),
    ('number_of_smoothing_iterations', 'GetNumberOfSmoothingIterations'),
    ('sub_image_size', 'GetSubImageSize'), ('progress', 'GetProgress'),
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            View((['decimation', 'smoothing'], ['color_mode', 'output_style'],
            ['decimation_error', 'error', 'number_of_smoothing_iterations',
            'sub_image_size']),
            title='Edit ImageToPolyDataFilter properties', scrollable=True, resizable=True,
            handler=TVTKBaseHandler,
