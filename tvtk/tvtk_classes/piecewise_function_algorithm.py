...
class PiecewiseFunctionAlgorithm(Algorithm):
    """
    PiecewiseFunctionAlgorithm - Superclass for algorithms that
    produce only piecewise function as output
    
    Superclass: Algorithm
    
    PiecewiseFunctionAlgorithm is a convenience class to make writing
    ...
    default says that all inputs will be piecewise_function. If that isn't
    ...
    def __init__(self, obj=None, update=True, **traits):
        tvtk_base.TVTKBase.__init__(self, vtk.vtkPiecewiseFunctionAlgorithm, obj, update, **traits)
    ...
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(PiecewiseFunctionAlgorithm, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            View((Item("handler._full_traits_list",show_label=False)),
            title='Edit PiecewiseFunctionAlgorithm properties', scrollable=True, resizable=True,
