...
class UnstructuredGridWriter(DataWriter):
    """
    UnstructuredGridWriter - write vtk unstructured grid data file
    
    Superclass: DataWriter
    
    UnstructuredGridWriter is a source object that writes ASCII or
    ...
    def __init__(self, obj=None, update=True, **traits):
        tvtk_base.TVTKBase.__init__(self, vtk.vtkUnstructuredGridWriter, obj, update, **traits)
    ...
    def get_input(self, *args):
        ...
        V.get_input(int) -> UnstructuredGrid
        C++: UnstructuredGrid *GetInput(int port)
    ...
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(UnstructuredGridWriter, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            View((Item("handler._full_traits_list",show_label=False)),
            title='Edit UnstructuredGridWriter properties', scrollable=True, resizable=True,
