...
class HierarchicalGraphPipeline(Object):
    ...
    'GetBundlingStrength'), ('color_array_name', 'GetColorArrayName'),
    ('hover_array_name', 'GetHoverArrayName'), ('label_array_name',
    'GetLabelArrayName'), ('spline_type', 'GetSplineType'),
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            View((['color_edges_by_array', 'label_visibility', 'visibility'], [],
            ['bundling_strength', 'color_array_name', 'hover_array_name',
            'label_array_name', 'spline_type']),
            title='Edit HierarchicalGraphPipeline properties', scrollable=True, resizable=True,
            handler=TVTKBaseHandler,
            buttons=['OK', 'Cancel'])
            return view
