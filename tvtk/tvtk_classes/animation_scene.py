...
class AnimationScene(AnimationCue):
    ...
    'GetGlobalWarningDisplay'), ('time_mode', 'GetTimeMode'),
    ('animation_time', 'GetAnimationTime'), ('frame_rate',
    'GetFrameRate'), ('loop', 'GetLoop'), ('play_mode', 'GetPlayMode'),
    ('end_time', 'GetEndTime'), ('start_time', 'GetStartTime'),
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            View(([], ['time_mode'], ['animation_time', 'end_time', 'frame_rate',
            'loop', 'play_mode', 'start_time']),
            title='Edit AnimationScene properties', scrollable=True, resizable=True,
            handler=TVTKBaseHandler,
            buttons=['OK', 'Cancel'])
            return view
