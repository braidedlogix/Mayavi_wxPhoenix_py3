...
class UnstructuredGridBaseAlgorithm(Algorithm):
    """
    UnstructuredGridBaseAlgorithm - Superclass for algorithms that
    produce only UnstructureGridBase subclasses as output
    
    Superclass: Algorithm
    
    UnstructuredGridBaseAlgorithm is a convenience class to make
    ...
    inputs will be unstructured_grid_base. If that isn't the case then
    please override this method in your subclass.
    
    """
    def __init__(self, obj=None, update=True, **traits):
        tvtk_base.TVTKBase.__init__(self, vtk.vtkUnstructuredGridBaseAlgorithm, obj, update, **traits)
    ...
    def get_output(self, idx=None):
        """
        V.get_output() -> UnstructuredGridBase
        C++: UnstructuredGridBase *GetOutput()
        V.get_output(int) -> UnstructuredGridBase
        C++: UnstructuredGridBase *GetOutput(int)
    ...
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(UnstructuredGridBaseAlgorithm, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            View((Item("handler._full_traits_list",show_label=False)),
            title='Edit UnstructuredGridBaseAlgorithm properties', scrollable=True, resizable=True,
