...
from tvtk.tvtk_classes.double_array import DoubleArray


class TypeFloat64Array(DoubleArray):
    """
    TypeFloat64Array - dynamic, self-adjusting array of TypeFloat64
    
    Superclass: DoubleArray
    
    TypeFloat64Array is an array of values of type TypeFloat64.  It
    ...
    def __init__(self, obj=None, update=True, **traits):
        tvtk_base.TVTKBase.__init__(self, vtk.vtkTypeFloat64Array, obj, update, **traits)
    ...
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(TypeFloat64Array, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            View((Item("handler._full_traits_list",show_label=False)),
            title='Edit TypeFloat64Array properties', scrollable=True, resizable=True,
