...
class PDataSetReader(DataSetAlgorithm):
    """
    PDataSetReader - Manages reading pieces of a data set.
    
    Superclass: DataSetAlgorithm
    
    PDataSetReader will read a piece of a file, it takes as input a
    metadata file that lists all of the files in a data set.
    
    """
    def __init__(self, obj=None, update=True, **traits):
        tvtk_base.TVTKBase.__init__(self, vtk.vtkPDataSetReader, obj, update, **traits)
    ...
    data_type = traits.Property(_get_data_type, help=\
        """
        This is set when update_information is called. It shows the type
        of the output.
        """
    )
    ...
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(PDataSetReader, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            View((Item("handler._full_traits_list",show_label=False)),
            title='Edit PDataSetReader properties', scrollable=True, resizable=True,
