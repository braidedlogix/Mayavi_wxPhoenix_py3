...
from tvtk.tvtk_classes.overlapping_amr import OverlappingAMR


class HierarchicalBoxDataSet(OverlappingAMR):
    """
    HierarchicalBoxDataSet - Backwards compatibility class
    
    Superclass: OverlappingAMR
    
    An empty class for backwards compatiblity
    
    @sa
    UniformGridAM OverlappingAMR NonOverlappingAMR
