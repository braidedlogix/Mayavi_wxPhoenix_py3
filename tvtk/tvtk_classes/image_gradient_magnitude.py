...
class ImageGradientMagnitude(ThreadedImageAlgorithm):
    """
    ImageGradientMagnitude - Computes magnitude of the gradient.
    
    Superclass: ThreadedImageAlgorithm
    
    ImageGradientMagnitude computes the gradient magnitude of an
    ...
    @sa
    ImageGradient ImageMagnitude
    
    """
    def __init__(self, obj=None, update=True, **traits):
        tvtk_base.TVTKBase.__init__(self, vtk.vtkImageGradientMagnitude, obj, update, **traits)
    ...
    _updateable_traits_ = \
    (('handle_boundaries', 'GetHandleBoundaries'), ('abort_execute',
    'GetAbortExecute'), ('release_data_flag', 'GetReleaseDataFlag'),
    ('debug', 'GetDebug'), ('global_warning_display',
    'GetGlobalWarningDisplay'), ('split_mode', 'GetSplitMode'),
    ('dimensionality', 'GetDimensionality'), ('desired_bytes_per_piece',
    ...
    'handle_boundaries', 'release_data_flag', 'split_mode',
    ...
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(ImageGradientMagnitude, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            View((Item("handler._full_traits_list",show_label=False)),
            title='Edit ImageGradientMagnitude properties', scrollable=True, resizable=True,
            handler=TVTKBaseHandler,
            buttons=['OK', 'Cancel'])
            return full_traits_view
        elif name == 'view':
            view = \
            View((['handle_boundaries'], ['split_mode'],
            ['desired_bytes_per_piece', 'dimensionality', 'enable_smp',
            'global_default_enable_smp', 'minimum_piece_size',
            'number_of_threads']),
            title='Edit ImageGradientMagnitude properties', scrollable=True, resizable=True,
