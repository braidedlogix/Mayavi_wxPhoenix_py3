...
class UnsignedShortArray(DataArray):
    """
    UnsignedShortArray - dynamic, self-adjusting array of unsigned
    short
    
    Superclass: DataArray
    
    UnsignedShortArray is an array of values of type unsigned short.
    ...
    bit unsigned integers is needed, prefer TypeUInt16Array to this
    class.
    
    """
    def __init__(self, obj=None, update=True, **traits):
        tvtk_base.TVTKBase.__init__(self, vtk.vtkUnsignedShortArray, obj, update, **traits)
    ...
    def get_typed_tuple(self, *args):
        ...
        C++: void GetTypedTuple(IdType i, unsigned short *tuple)"""
    ...
    def set_typed_tuple(self, *args):
        ...
        C++: void SetTypedTuple(IdType i, const unsigned short *tuple)"""
    ...
    def get_value(self, *args):
        """
        V.get_value(int) -> int
        C++: unsigned short GetValue(IdType id)"""
    ...
    def set_value(self, *args):
        """
        V.set_value(int, int)
        C++: void SetValue(IdType id, unsigned short value)"""
    ...
    def get_pointer(self, *args):
        ...
        C++: unsigned short *GetPointer(IdType id)"""
    ...
    def insert_next_typed_tuple(self, *args):
        ...
        C++: IdType InsertNextTypedTuple(const unsigned short *tuple)"""
    ...
    def insert_next_value(self, *args):
        ...
        C++: IdType InsertNextValue(unsigned short f)"""
    ...
    def insert_value(self, *args):
        ...
        C++: void InsertValue(IdType id, unsigned short f)"""
    ...
    def write_pointer(self, *args):
        ...
        C++: unsigned short *WritePointer(IdType id, IdType number)"""
    ...
    def trait_view(self, name=None, view_element=None):
        if view_element is not None or name not in (None, '', 'traits_view', 'full_traits_view', 'view'):
            return super(UnsignedShortArray, self).trait_view(name, view_element)
        if name == 'full_traits_view':
            full_traits_view = \
            View((Item("handler._full_traits_list",show_label=False)),
            title='Edit UnsignedShortArray properties', scrollable=True, resizable=True,
