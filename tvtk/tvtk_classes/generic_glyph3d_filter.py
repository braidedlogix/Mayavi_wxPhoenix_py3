...
class GenericGlyph3DFilter(PolyDataAlgorithm):
    ...
    _updateable_traits_ = \
    (('clamping', 'GetClamping'), ('generate_point_ids',
    'GetGeneratePointIds'), ('orient', 'GetOrient'), ('scaling',
    'GetScaling'), ('abort_execute', 'GetAbortExecute'),
    ('release_data_flag', 'GetReleaseDataFlag'), ('debug', 'GetDebug'),
    ('global_warning_display', 'GetGlobalWarningDisplay'), ('color_mode',
    'GetColorMode'), ('index_mode', 'GetIndexMode'), ('scale_mode',
    'GetScaleMode'), ('vector_mode', 'GetVectorMode'), ('point_ids_name',
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            View((['clamping', 'generate_point_ids', 'orient', 'scaling'],
            ['color_mode', 'index_mode', 'scale_mode', 'vector_mode'],
