...
class ConvertSelection(SelectionAlgorithm):
    ...
    _updateable_traits_ = \
    (('match_any_values', 'GetMatchAnyValues'), ('abort_execute',
    'GetAbortExecute'), ('release_data_flag', 'GetReleaseDataFlag'),
    ('debug', 'GetDebug'), ('global_warning_display',
    'GetGlobalWarningDisplay'), ('array_name', 'GetArrayName'),
    ('input_field_type', 'GetInputFieldType'), ('output_type',
    ...
    def trait_view(self, name=None, view_element=None):
        ...
        if name == 'full_traits_view':
            ...
            view = \
            View((['match_any_values'], [], ['array_name', 'input_field_type',
            'output_type']),
            title='Edit ConvertSelection properties', scrollable=True, resizable=True,
            handler=TVTKBaseHandler,
            buttons=['OK', 'Cancel'])
