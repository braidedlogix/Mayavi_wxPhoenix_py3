...
class ImageTranslateExtent(ImageAlgorithm):
    ...
    translation = traits.Array(enter_set=True, auto_set=False, shape=(3,), dtype=int, value=(0, 0, 0), cols=3, help=\
        """
    ...
    ('global_warning_display', 'GetGlobalWarningDisplay'), ('translation',
    'GetTranslation'), ('progress', 'GetProgress'), ('progress_text',
