...
scene_group = Group(
    id='TVTKSceneGroup', path='MenuBar/File', before='ExitGroup')

view_group = Group(
    id='TVTKViewGroup', path='MenuBar/Tools', before='PreferencesGroup')
...
save_scene_to_ps = Action(
    class_name=PKG + '.actions.SaveSceneToPS', path='MenuBar/File/SaveSceneAs')
...
save_scene_to_iv = Action(
    class_name=PKG + '.actions.SaveSceneToIV', path='MenuBar/File/SaveSceneAs')
