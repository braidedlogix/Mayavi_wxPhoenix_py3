...
cursor3d = mlab.points3d(
    0., 0., 0., mode='axes', color=(0, 0, 0), scale_factor=0.5)
...
cursor = mlab.points3d(
    0, 0, 0, mode='2dthick_cross', color=(0, 0, 0), scale_factor=10)
mlab.view(90, 0)
...
def picker_callback(picker_obj):
    ...
    if mesh.actor.actor._vtk_obj in [o._vtk_obj for o in picked]:
        ...
        n_x, n_y = s.shape
        cursor.mlab_source.reset(x=x_ - n_x / 2., y=y_ - n_y / 2.)
