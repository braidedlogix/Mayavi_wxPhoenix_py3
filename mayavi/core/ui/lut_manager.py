    ...
    Group(
        Item(
            ...
            editor=ImageEnumEditor(
                values=lut_mode_list(),
                cols=_number_of_lut_cols(),
                path=lut_image_dir)),
        Item(
            name='file_name', visible_when="lut_mode=='file'"),
        ...
        Item(
            ...
            editor=InstanceEditor(
                label='Edit LUT properties',
                id='mayavi.core.lut_manager.edit_lut')),
        Item(
            name='scalar_bar_representation',
            show_label=False,
        ...
        Item(
            name='create_lut', show_label=False),
        Group(
            ...
            Group(
                ...
                HGroup(
                    ...
                    Item(
                        name='scalar_bar_widget',
                        show_label=False,
                        editor=InstanceEditor(
                            label='Edit bar Widget',
