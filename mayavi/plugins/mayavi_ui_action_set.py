...
file_group = Group(
    id='MayaviFileGroup', path='MenuBar/File', before='ExitGroup')
...
visualize_menu = Menu(
    id="VisualizeMenu", name="Visuali&ze", path="MenuBar", before="View")
...
class MayaviUIActionSet(ActionSet):
    ...
    menus = [open_menu, visualize_menu, modules_menu, filters_menu]
