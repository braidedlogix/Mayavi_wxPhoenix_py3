...
class TestBuiltinSurfaceSource(unittest.TestCase):
    ...
    def check(self):
        ...
        self.assertEqual(
            numpy.allclose(
                ot.outline_filter.output.bounds,
        ...
        self.assertEqual(
            numpy.allclose(
                src.data_source.angle, 26.565, atol=1.01e-03), True)
        self.assertEqual(
            numpy.allclose(src.data_source.direction, (1., 0., 0.)), True)
        ...
        self.assertEqual(
            numpy.allclose(
                src.data_source.radius, 0.866, atol=1.01e-03), True)
