{
    'array': array(
        [(860.0, 118.42, nan, 48.45, 0.826, 0.833, 0.37, 5.315, 2.31),
         ...
         (896.576, 108.127, 160.44, 54.145, 0.724, 0.764, 0.352, 10.669,
          2.289), (896.881, 107.312, 156.969, 57.37, 0.545, 0.622, 0.333,
                   19.721, 2.207),
         (897.0, 109.566, nan, 49.631, 0.518, 0.604, 0.31, 10.997, 2.232), (
             898.0, 112.73, nan, 46.016, 0.479, 0.546, 0.314, 9.892, 2.157)],
        dtype=[('depth', float), ('DT4P', float), ('DT4S', float),
               ('GR', float), ('ILD', float), ('ILM', float), ('NPHI', float),
               ('PEF', float), ('RHOB', float)]),
    'kwds': {
        'comments': '#',
        'delimiter': ',',
        'dtype': {
            'formats': 9 * (float, ),
            'names': ('depth', 'DT4P', 'DT4S', 'GR', 'ILD', 'ILM', 'NPHI',
                      'PEF', 'RHOB')
        },
        'skiprows': 4
    }
